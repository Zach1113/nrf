...
type SearchNFInstances struct {
	TargetNFType            models.Nrf_NFMgmt_NFType          `form:"target-nf-type" binding:"required"`
	RequesterNFType         models.Nrf_NFMgmt_NFType          `form:"requester-nf-type" binding:"required"`
	ServiceNames            []models.Nrf_NFMgmt_ServiceName   `form:"service-names" `
	...
	PlmnSpecificSnssaiList  []models.Nrf_NFMgmt_PlmnSnssai    `form:"plmn-specific-snssai-list"`
	Dnn                     string                            `form:"dnn" `
	...
	DataSet                 models.Nrf_NFMgmt_DataSetId       `form:"data-set" `
	...
	NwdafEventList          []models.Nwdaf_EvtSubs_NwdafEvent `form:"nwdaf-event-list" `
